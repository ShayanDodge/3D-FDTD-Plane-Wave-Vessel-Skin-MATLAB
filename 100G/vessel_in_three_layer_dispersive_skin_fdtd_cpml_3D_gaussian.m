...
material_type(5).eps_r=2.8;
material_type(5).mu_r=1;
material_type(5).sigma_e=2.13;
material_type(5).sigma_m=1e-20;
material_type(5).color=[1 0 0];
material_type(5).debye_eps_s=72.82;
material_type(5).debye_A=1.074;
material_type(5).debye_tau=8.68.*10^-12;
...
Ezp=Ez;
%% update source
Ex(1:nx,1:ny,n_cpml_zn+15)=Ex(1:nx,1:ny,n_cpml_zn+15)+muSource *(number * dt - t0)...
...
for ind=1:number_of_brick
hold on
patch([brick(ind).min_x+0.01 brick(ind).min_x+0.01 brick(ind).max_x-0.01 ...
    brick(ind).max_x-0.01],[brick(ind).min_y+0.01 brick(ind).max_y-0.01...
    brick(ind).max_y-0.01 brick(ind).min_y+0.01],[brick(ind).min_z...
    brick(ind).min_z brick(ind).min_z brick(ind).min_z],...
    material_type(ind+1).color)
patch([brick(ind).min_x+0.01 brick(ind).min_x+0.01 brick(ind).max_x-0.01...
    brick(ind).max_x-0.01], [brick(ind).min_y+0.01 brick(ind).max_y-0.01...
    brick(ind).max_y-0.01 brick(ind).min_y+0.01], [brick(ind).max_z...
    brick(ind).max_z brick(ind).max_z brick(ind).max_z],...
    material_type(ind+1).color)
patch([brick(ind).min_x+0.01 brick(ind).min_x+0.01 brick(ind).min_x+0.01...
    brick(ind).min_x+0.01], [brick(ind).min_y+0.01 brick(ind).max_y-0.01...
    brick(ind).max_y-0.01 brick(ind).min_y+0.01], [brick(ind).min_z...
    brick(ind).min_z brick(ind).max_z brick(ind).max_z],...
    material_type(ind+1).color)
patch([brick(ind).max_x-0.01 brick(ind).max_x-0.01 brick(ind).max_x-0.01...
    brick(ind).max_x-0.01], [brick(ind).min_y+0.01 brick(ind).max_y-0.01...
    brick(ind).max_y-0.01 brick(ind).min_y+0.01], [brick(ind).min_z...
    brick(ind).min_z brick(ind).max_z brick(ind).max_z],...
    material_type(ind+1).color)
patch([brick(ind).min_x+0.01 brick(ind).min_x+0.01 brick(ind).max_x-0.01...
    brick(ind).max_x-0.01], [brick(ind).min_y+0.01 brick(ind).min_y+0.01...
    brick(ind).min_y+0.01 brick(ind).min_y+0.01], [brick(ind).min_z...
    brick(ind).max_z brick(ind).max_z brick(ind).min_z],...
    material_type(ind+1).color)
patch([brick(ind).min_x+0.01 brick(ind).min_x+0.01 brick(ind).max_x-0.01...
    brick(ind).max_x-0.01], [brick(ind).max_y-0.01 brick(ind).max_y-0.01...
    brick(ind).max_y-0.01 brick(ind).max_y-0.01], [brick(ind).min_z...
    brick(ind).max_z brick(ind).max_z brick(ind).min_z],...
    material_type(ind+1).color)
end
...
h=slice(x,y,z,Ex_sample,-0.02,-0.02,[],'cubic')
...
view(3)
alpha(0.7)
savefig(Hh_1,'vessel_in_three_layer_dispersive_skin_fdtd_cpml_gaussian_100G_3D_3D.fig')
...
ylim([-2 2]);
grid on
savefig(Hh_2,'vessel_in_three_layer_dispersive_skin_fdtd_cpml_gaussian_100G_3D_2D.fig')
for i=1:nzp1
...
grid on
savefig(Hh_3,'vessel_in_three_layer_dispersive_skin_fdtd_cpml_gaussian_100G_3D_2D_1.fig')
end
disp(number)
end